...
fn wasmer_import_get_gas_left(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_gas_left()
}

#[rustfmt::skip]
fn wasmer_import_get_sc_address(env: &VMHooksWrapper, result_offset: i32) {
    env.vm_hooks.borrow_mut().get_sc_address(env.convert_mem_ptr(result_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_owner_address(env: &VMHooksWrapper, result_offset: i32) {
    env.vm_hooks.borrow_mut().get_owner_address(env.convert_mem_ptr(result_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_shard_of_address(env: &VMHooksWrapper, address_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_shard_of_address(env.convert_mem_ptr(address_offset))
}

#[rustfmt::skip]
fn wasmer_import_is_smart_contract(env: &VMHooksWrapper, address_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().is_smart_contract(env.convert_mem_ptr(address_offset))
}

#[rustfmt::skip]
fn wasmer_import_signal_error(env: &VMHooksWrapper, message_offset: i32, message_length: i32) {
    env.vm_hooks.borrow_mut().signal_error(env.convert_mem_ptr(message_offset), env.convert_mem_length(message_length))
}

#[rustfmt::skip]
fn wasmer_import_get_external_balance(env: &VMHooksWrapper, address_offset: i32, result_offset: i32) {
    env.vm_hooks.borrow_mut().get_external_balance(env.convert_mem_ptr(address_offset), env.convert_mem_ptr(result_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_block_hash(env: &VMHooksWrapper, nonce: i64, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_block_hash(nonce, env.convert_mem_ptr(result_offset))
}
...
fn wasmer_import_get_esdt_balance(env: &VMHooksWrapper, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_balance(env.convert_mem_ptr(address_offset), env.convert_mem_ptr(token_id_offset), env.convert_mem_length(token_id_len), nonce, env.convert_mem_ptr(result_offset))
}
...
fn wasmer_import_get_esdt_nft_name_length(env: &VMHooksWrapper, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_nft_name_length(env.convert_mem_ptr(address_offset), env.convert_mem_ptr(token_id_offset), env.convert_mem_length(token_id_len), nonce)
}
...
fn wasmer_import_get_esdt_nft_attribute_length(env: &VMHooksWrapper, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_nft_attribute_length(env.convert_mem_ptr(address_offset), env.convert_mem_ptr(token_id_offset), env.convert_mem_length(token_id_len), nonce)
}
...
fn wasmer_import_get_esdt_nft_uri_length(env: &VMHooksWrapper, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_nft_uri_length(env.convert_mem_ptr(address_offset), env.convert_mem_ptr(token_id_offset), env.convert_mem_length(token_id_len), nonce)
}
...
fn wasmer_import_transfer_value_execute(env: &VMHooksWrapper, dest_offset: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().transfer_value_execute(env.convert_mem_ptr(dest_offset), env.convert_mem_ptr(value_offset), gas_limit, env.convert_mem_ptr(function_offset), env.convert_mem_length(function_length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_transfer_esdt_execute(env: &VMHooksWrapper, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().transfer_esdt_execute(env.convert_mem_ptr(dest_offset), env.convert_mem_ptr(token_id_offset), env.convert_mem_length(token_id_len), env.convert_mem_ptr(value_offset), gas_limit, env.convert_mem_ptr(function_offset), env.convert_mem_length(function_length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_transfer_esdt_nft_execute(env: &VMHooksWrapper, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, nonce: i64, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().transfer_esdt_nft_execute(env.convert_mem_ptr(dest_offset), env.convert_mem_ptr(token_id_offset), env.convert_mem_length(token_id_len), env.convert_mem_ptr(value_offset), nonce, gas_limit, env.convert_mem_ptr(function_offset), env.convert_mem_length(function_length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_multi_transfer_esdt_nft_execute(env: &VMHooksWrapper, dest_offset: i32, num_token_transfers: i32, token_transfers_args_length_offset: i32, token_transfer_data_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().multi_transfer_esdt_nft_execute(env.convert_mem_ptr(dest_offset), num_token_transfers, env.convert_mem_ptr(token_transfers_args_length_offset), env.convert_mem_ptr(token_transfer_data_offset), gas_limit, env.convert_mem_ptr(function_offset), env.convert_mem_length(function_length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_set_async_context_callback(env: &VMHooksWrapper, callback: i32, callback_length: i32, data: i32, data_length: i32, gas: i64) -> i32 {
    env.vm_hooks.borrow_mut().set_async_context_callback(env.convert_mem_ptr(callback), env.convert_mem_length(callback_length), env.convert_mem_ptr(data), env.convert_mem_length(data_length), gas)
}
...
fn wasmer_import_upgrade_contract(env: &VMHooksWrapper, dest_offset: i32, gas_limit: i64, value_offset: i32, code_offset: i32, code_metadata_offset: i32, length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) {
    env.vm_hooks.borrow_mut().upgrade_contract(env.convert_mem_ptr(dest_offset), gas_limit, env.convert_mem_ptr(value_offset), env.convert_mem_ptr(code_offset), env.convert_mem_ptr(code_metadata_offset), env.convert_mem_length(length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_delete_contract(env: &VMHooksWrapper, dest_offset: i32, gas_limit: i64, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) {
    env.vm_hooks.borrow_mut().delete_contract(env.convert_mem_ptr(dest_offset), gas_limit, num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_async_call(env: &VMHooksWrapper, dest_offset: i32, value_offset: i32, data_offset: i32, length: i32) {
    env.vm_hooks.borrow_mut().async_call(env.convert_mem_ptr(dest_offset), env.convert_mem_ptr(value_offset), env.convert_mem_ptr(data_offset), env.convert_mem_length(length))
}

#[rustfmt::skip]
fn wasmer_import_get_argument_length(env: &VMHooksWrapper, id: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_argument_length(id)
}

#[rustfmt::skip]
fn wasmer_import_get_argument(env: &VMHooksWrapper, id: i32, arg_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_argument(id, env.convert_mem_ptr(arg_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_function(env: &VMHooksWrapper, function_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_function(env.convert_mem_ptr(function_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_num_arguments(env: &VMHooksWrapper) -> i32 {
    env.vm_hooks.borrow_mut().get_num_arguments()
}

#[rustfmt::skip]
fn wasmer_import_storage_store(env: &VMHooksWrapper, key_offset: i32, key_length: i32, data_offset: i32, data_length: i32) -> i32 {
    env.vm_hooks.borrow_mut().storage_store(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length), env.convert_mem_ptr(data_offset), env.convert_mem_length(data_length))
}

#[rustfmt::skip]
fn wasmer_import_storage_load_length(env: &VMHooksWrapper, key_offset: i32, key_length: i32) -> i32 {
    env.vm_hooks.borrow_mut().storage_load_length(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length))
}
...
fn wasmer_import_storage_load_from_address(env: &VMHooksWrapper, address_offset: i32, key_offset: i32, key_length: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().storage_load_from_address(env.convert_mem_ptr(address_offset), env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length), env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_storage_load(env: &VMHooksWrapper, key_offset: i32, key_length: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().storage_load(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length), env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_set_storage_lock(env: &VMHooksWrapper, key_offset: i32, key_length: i32, lock_timestamp: i64) -> i32 {
    env.vm_hooks.borrow_mut().set_storage_lock(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length), lock_timestamp)
}

#[rustfmt::skip]
fn wasmer_import_get_storage_lock(env: &VMHooksWrapper, key_offset: i32, key_length: i32) -> i64 {
    env.vm_hooks.borrow_mut().get_storage_lock(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length))
}

#[rustfmt::skip]
fn wasmer_import_is_storage_locked(env: &VMHooksWrapper, key_offset: i32, key_length: i32) -> i32 {
    env.vm_hooks.borrow_mut().is_storage_locked(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length))
}

#[rustfmt::skip]
fn wasmer_import_clear_storage_lock(env: &VMHooksWrapper, key_offset: i32, key_length: i32) -> i32 {
    env.vm_hooks.borrow_mut().clear_storage_lock(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length))
}

#[rustfmt::skip]
fn wasmer_import_get_caller(env: &VMHooksWrapper, result_offset: i32) {
    env.vm_hooks.borrow_mut().get_caller(env.convert_mem_ptr(result_offset))
}

#[rustfmt::skip]
fn wasmer_import_check_no_payment(env: &VMHooksWrapper) {
    env.vm_hooks.borrow_mut().check_no_payment()
}

#[rustfmt::skip]
fn wasmer_import_get_call_value(env: &VMHooksWrapper, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_call_value(env.convert_mem_ptr(result_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_value(env: &VMHooksWrapper, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_value(env.convert_mem_ptr(result_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_value_by_index(env: &VMHooksWrapper, result_offset: i32, index: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_value_by_index(env.convert_mem_ptr(result_offset), index)
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_name(env: &VMHooksWrapper, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_token_name(env.convert_mem_ptr(result_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_name_by_index(env: &VMHooksWrapper, result_offset: i32, index: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_token_name_by_index(env.convert_mem_ptr(result_offset), index)
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_nonce(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_esdt_token_nonce()
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_nonce_by_index(env: &VMHooksWrapper, index: i32) -> i64 {
    env.vm_hooks.borrow_mut().get_esdt_token_nonce_by_index(index)
}
...
fn wasmer_import_get_current_esdt_nft_nonce(env: &VMHooksWrapper, address_offset: i32, token_id_offset: i32, token_id_len: i32) -> i64 {
    env.vm_hooks.borrow_mut().get_current_esdt_nft_nonce(env.convert_mem_ptr(address_offset), env.convert_mem_ptr(token_id_offset), env.convert_mem_length(token_id_len))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_type(env: &VMHooksWrapper) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_token_type()
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_type_by_index(env: &VMHooksWrapper, index: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_esdt_token_type_by_index(index)
}

#[rustfmt::skip]
fn wasmer_import_get_num_esdt_transfers(env: &VMHooksWrapper) -> i32 {
    env.vm_hooks.borrow_mut().get_num_esdt_transfers()
}

#[rustfmt::skip]
fn wasmer_import_get_call_value_token_name(env: &VMHooksWrapper, call_value_offset: i32, token_name_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_call_value_token_name(env.convert_mem_ptr(call_value_offset), env.convert_mem_ptr(token_name_offset))
}
...
fn wasmer_import_get_call_value_token_name_by_index(env: &VMHooksWrapper, call_value_offset: i32, token_name_offset: i32, index: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_call_value_token_name_by_index(env.convert_mem_ptr(call_value_offset), env.convert_mem_ptr(token_name_offset), index)
}

#[rustfmt::skip]
fn wasmer_import_is_reserved_function_name(env: &VMHooksWrapper, name_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().is_reserved_function_name(name_handle)
}

#[rustfmt::skip]
fn wasmer_import_write_log(env: &VMHooksWrapper, data_pointer: i32, data_length: i32, topic_ptr: i32, num_topics: i32) {
    env.vm_hooks.borrow_mut().write_log(env.convert_mem_ptr(data_pointer), env.convert_mem_length(data_length), env.convert_mem_ptr(topic_ptr), num_topics)
}
...
fn wasmer_import_write_event_log(env: &VMHooksWrapper, num_topics: i32, topic_lengths_offset: i32, topic_offset: i32, data_offset: i32, data_length: i32) {
    env.vm_hooks.borrow_mut().write_event_log(num_topics, env.convert_mem_ptr(topic_lengths_offset), env.convert_mem_ptr(topic_offset), env.convert_mem_ptr(data_offset), env.convert_mem_length(data_length))
}

#[rustfmt::skip]
fn wasmer_import_get_block_timestamp(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_block_timestamp()
}

#[rustfmt::skip]
fn wasmer_import_get_block_nonce(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_block_nonce()
}

#[rustfmt::skip]
fn wasmer_import_get_block_round(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_block_round()
}

#[rustfmt::skip]
fn wasmer_import_get_block_epoch(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_block_epoch()
}

#[rustfmt::skip]
fn wasmer_import_get_block_random_seed(env: &VMHooksWrapper, pointer: i32) {
    env.vm_hooks.borrow_mut().get_block_random_seed(env.convert_mem_ptr(pointer))
}

#[rustfmt::skip]
fn wasmer_import_get_state_root_hash(env: &VMHooksWrapper, pointer: i32) {
    env.vm_hooks.borrow_mut().get_state_root_hash(env.convert_mem_ptr(pointer))
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_timestamp(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_prev_block_timestamp()
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_nonce(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_prev_block_nonce()
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_round(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_prev_block_round()
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_epoch(env: &VMHooksWrapper) -> i64 {
    env.vm_hooks.borrow_mut().get_prev_block_epoch()
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_random_seed(env: &VMHooksWrapper, pointer: i32) {
    env.vm_hooks.borrow_mut().get_prev_block_random_seed(env.convert_mem_ptr(pointer))
}

#[rustfmt::skip]
fn wasmer_import_finish(env: &VMHooksWrapper, pointer: i32, length: i32) {
    env.vm_hooks.borrow_mut().finish(env.convert_mem_ptr(pointer), env.convert_mem_length(length))
}
...
fn wasmer_import_execute_on_same_context(env: &VMHooksWrapper, gas_limit: i64, address_offset: i32, value_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().execute_on_same_context(gas_limit, env.convert_mem_ptr(address_offset), env.convert_mem_ptr(value_offset), env.convert_mem_ptr(function_offset), env.convert_mem_length(function_length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_execute_on_dest_context(env: &VMHooksWrapper, gas_limit: i64, address_offset: i32, value_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().execute_on_dest_context(gas_limit, env.convert_mem_ptr(address_offset), env.convert_mem_ptr(value_offset), env.convert_mem_ptr(function_offset), env.convert_mem_length(function_length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_execute_read_only(env: &VMHooksWrapper, gas_limit: i64, address_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().execute_read_only(gas_limit, env.convert_mem_ptr(address_offset), env.convert_mem_ptr(function_offset), env.convert_mem_length(function_length), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}
...
fn wasmer_import_deploy_from_source_contract(env: &VMHooksWrapper, gas_limit: i64, value_offset: i32, source_contract_address_offset: i32, code_metadata_offset: i32, result_address_offset: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().deploy_from_source_contract(gas_limit, env.convert_mem_ptr(value_offset), env.convert_mem_ptr(source_contract_address_offset), env.convert_mem_ptr(code_metadata_offset), env.convert_mem_ptr(result_address_offset), num_arguments, env.convert_mem_ptr(arguments_length_offset), env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_num_return_data(env: &VMHooksWrapper) -> i32 {
    env.vm_hooks.borrow_mut().get_num_return_data()
}

#[rustfmt::skip]
fn wasmer_import_get_return_data_size(env: &VMHooksWrapper, result_id: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_return_data_size(result_id)
}

#[rustfmt::skip]
fn wasmer_import_get_return_data(env: &VMHooksWrapper, result_id: i32, data_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_return_data(result_id, env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_clean_return_data(env: &VMHooksWrapper) {
    env.vm_hooks.borrow_mut().clean_return_data()
}

#[rustfmt::skip]
fn wasmer_import_delete_from_return_data(env: &VMHooksWrapper, result_id: i32) {
    env.vm_hooks.borrow_mut().delete_from_return_data(result_id)
}

#[rustfmt::skip]
fn wasmer_import_get_original_tx_hash(env: &VMHooksWrapper, data_offset: i32) {
    env.vm_hooks.borrow_mut().get_original_tx_hash(env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_current_tx_hash(env: &VMHooksWrapper, data_offset: i32) {
    env.vm_hooks.borrow_mut().get_current_tx_hash(env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_get_prev_tx_hash(env: &VMHooksWrapper, data_offset: i32) {
    env.vm_hooks.borrow_mut().get_prev_tx_hash(env.convert_mem_ptr(data_offset))
}

#[rustfmt::skip]
fn wasmer_import_managed_sc_address(env: &VMHooksWrapper, destination_handle: i32) {
    env.vm_hooks.borrow_mut().managed_sc_address(destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_owner_address(env: &VMHooksWrapper, destination_handle: i32) {
    env.vm_hooks.borrow_mut().managed_owner_address(destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_caller(env: &VMHooksWrapper, destination_handle: i32) {
    env.vm_hooks.borrow_mut().managed_caller(destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_original_caller_addr(env: &VMHooksWrapper, destination_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_original_caller_addr(destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_relayer_addr(env: &VMHooksWrapper, destination_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_relayer_addr(destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_signal_error(env: &VMHooksWrapper, err_handle: i32) {
    env.vm_hooks.borrow_mut().managed_signal_error(err_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_write_log(env: &VMHooksWrapper, topics_handle: i32, data_handle: i32) {
    env.vm_hooks.borrow_mut().managed_write_log(topics_handle, data_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_original_tx_hash(env: &VMHooksWrapper, result_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_original_tx_hash(result_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_state_root_hash(env: &VMHooksWrapper, result_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_state_root_hash(result_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_block_random_seed(env: &VMHooksWrapper, result_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_block_random_seed(result_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_prev_block_random_seed(env: &VMHooksWrapper, result_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_prev_block_random_seed(result_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_return_data(env: &VMHooksWrapper, result_id: i32, result_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_return_data(result_id, result_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_multi_esdt_call_value(env: &VMHooksWrapper, multi_call_value_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_multi_esdt_call_value(multi_call_value_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_back_transfers(env: &VMHooksWrapper, esdt_transfers_value_handle: i32, egld_value_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_back_transfers(esdt_transfers_value_handle, egld_value_handle)
}
...
fn wasmer_import_managed_get_esdt_balance(env: &VMHooksWrapper, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_esdt_balance(address_handle, token_id_handle, nonce, value_handle)
}
...
fn wasmer_import_managed_get_esdt_token_data(env: &VMHooksWrapper, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32, properties_handle: i32, hash_handle: i32, name_handle: i32, attributes_handle: i32, creator_handle: i32, royalties_handle: i32, uris_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_esdt_token_data(address_handle, token_id_handle, nonce, value_handle, properties_handle, hash_handle, name_handle, attributes_handle, creator_handle, royalties_handle, uris_handle)
}
...
fn wasmer_import_managed_async_call(env: &VMHooksWrapper, dest_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32) {
    env.vm_hooks.borrow_mut().managed_async_call(dest_handle, value_handle, function_handle, arguments_handle)
}
...
fn wasmer_import_managed_create_async_call(env: &VMHooksWrapper, dest_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, success_offset: i32, success_length: i32, error_offset: i32, error_length: i32, gas: i64, extra_gas_for_callback: i64, callback_closure_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_create_async_call(dest_handle, value_handle, function_handle, arguments_handle, env.convert_mem_ptr(success_offset), env.convert_mem_length(success_length), env.convert_mem_ptr(error_offset), env.convert_mem_length(error_length), gas, extra_gas_for_callback, callback_closure_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_get_callback_closure(env: &VMHooksWrapper, callback_closure_handle: i32) {
    env.vm_hooks.borrow_mut().managed_get_callback_closure(callback_closure_handle)
}
...
fn wasmer_import_managed_upgrade_from_source_contract(env: &VMHooksWrapper, dest_handle: i32, gas: i64, value_handle: i32, address_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_handle: i32) {
    env.vm_hooks.borrow_mut().managed_upgrade_from_source_contract(dest_handle, gas, value_handle, address_handle, code_metadata_handle, arguments_handle, result_handle)
}
...
fn wasmer_import_managed_upgrade_contract(env: &VMHooksWrapper, dest_handle: i32, gas: i64, value_handle: i32, code_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_handle: i32) {
    env.vm_hooks.borrow_mut().managed_upgrade_contract(dest_handle, gas, value_handle, code_handle, code_metadata_handle, arguments_handle, result_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_delete_contract(env: &VMHooksWrapper, dest_handle: i32, gas_limit: i64, arguments_handle: i32) {
    env.vm_hooks.borrow_mut().managed_delete_contract(dest_handle, gas_limit, arguments_handle)
}
...
fn wasmer_import_managed_deploy_from_source_contract(env: &VMHooksWrapper, gas: i64, value_handle: i32, address_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_address_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_deploy_from_source_contract(gas, value_handle, address_handle, code_metadata_handle, arguments_handle, result_address_handle, result_handle)
}
...
fn wasmer_import_managed_create_contract(env: &VMHooksWrapper, gas: i64, value_handle: i32, code_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_address_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_create_contract(gas, value_handle, code_handle, code_metadata_handle, arguments_handle, result_address_handle, result_handle)
}
...
fn wasmer_import_managed_execute_read_only(env: &VMHooksWrapper, gas: i64, address_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_execute_read_only(gas, address_handle, function_handle, arguments_handle, result_handle)
}
...
fn wasmer_import_managed_execute_on_same_context(env: &VMHooksWrapper, gas: i64, address_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_execute_on_same_context(gas, address_handle, value_handle, function_handle, arguments_handle, result_handle)
}
...
fn wasmer_import_managed_execute_on_dest_context(env: &VMHooksWrapper, gas: i64, address_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_execute_on_dest_context(gas, address_handle, value_handle, function_handle, arguments_handle, result_handle)
}
...
fn wasmer_import_managed_multi_transfer_esdt_nft_execute(env: &VMHooksWrapper, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_multi_transfer_esdt_nft_execute(dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle)
}
...
fn wasmer_import_managed_multi_transfer_esdt_nft_execute_by_user(env: &VMHooksWrapper, user_handle: i32, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_multi_transfer_esdt_nft_execute_by_user(user_handle, dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle)
}
...
fn wasmer_import_big_int_storage_load_unsigned(env: &VMHooksWrapper, key_offset: i32, key_length: i32, destination_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().big_int_storage_load_unsigned(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length), destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_call_value(env: &VMHooksWrapper, destination_handle: i32) {
    env.vm_hooks.borrow_mut().big_int_get_call_value(destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_esdt_call_value(env: &VMHooksWrapper, destination: i32) {
    env.vm_hooks.borrow_mut().big_int_get_esdt_call_value(destination)
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_esdt_call_value_by_index(env: &VMHooksWrapper, destination_handle: i32, index: i32) {
    env.vm_hooks.borrow_mut().big_int_get_esdt_call_value_by_index(destination_handle, index)
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_external_balance(env: &VMHooksWrapper, address_offset: i32, result: i32) {
    env.vm_hooks.borrow_mut().big_int_get_external_balance(env.convert_mem_ptr(address_offset), result)
}
...
fn wasmer_import_mbuffer_get_byte_slice(env: &VMHooksWrapper, source_handle: i32, starting_position: i32, slice_length: i32, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().mbuffer_get_byte_slice(source_handle, starting_position, slice_length, env.convert_mem_ptr(result_offset))
}
...
fn wasmer_import_mbuffer_copy_byte_slice(env: &VMHooksWrapper, source_handle: i32, starting_position: i32, slice_length: i32, destination_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().mbuffer_copy_byte_slice(source_handle, starting_position, slice_length, destination_handle)
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_eq(env: &VMHooksWrapper, m_buffer_handle1: i32, m_buffer_handle2: i32) -> i32 {
    env.vm_hooks.borrow_mut().mbuffer_eq(m_buffer_handle1, m_buffer_handle2)
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_set_bytes(env: &VMHooksWrapper, m_buffer_handle: i32, data_offset: i32, data_length: i32) -> i32 {
    env.vm_hooks.borrow_mut().mbuffer_set_bytes(m_buffer_handle, env.convert_mem_ptr(data_offset), env.convert_mem_length(data_length))
}
...
fn wasmer_import_verify_ed25519(env: &VMHooksWrapper, key_offset: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().verify_ed25519(env.convert_mem_ptr(key_offset), env.convert_mem_ptr(message_offset), env.convert_mem_length(message_length), env.convert_mem_ptr(sig_offset))
}

#[rustfmt::skip]
fn wasmer_import_managed_verify_ed25519(env: &VMHooksWrapper, key_handle: i32, message_handle: i32, sig_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_verify_ed25519(key_handle, message_handle, sig_handle)
}
...
fn wasmer_import_verify_custom_secp256k1(env: &VMHooksWrapper, key_offset: i32, key_length: i32, message_offset: i32, message_length: i32, sig_offset: i32, hash_type: i32) -> i32 {
    env.vm_hooks.borrow_mut().verify_custom_secp256k1(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length), env.convert_mem_ptr(message_offset), env.convert_mem_length(message_length), env.convert_mem_ptr(sig_offset), hash_type)
}
...
fn wasmer_import_managed_verify_custom_secp256k1(env: &VMHooksWrapper, key_handle: i32, message_handle: i32, sig_handle: i32, hash_type: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_verify_custom_secp256k1(key_handle, message_handle, sig_handle, hash_type)
}
...
fn wasmer_import_verify_secp256k1(env: &VMHooksWrapper, key_offset: i32, key_length: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().verify_secp256k1(env.convert_mem_ptr(key_offset), env.convert_mem_length(key_length), env.convert_mem_ptr(message_offset), env.convert_mem_length(message_length), env.convert_mem_ptr(sig_offset))
}

#[rustfmt::skip]
fn wasmer_import_managed_verify_secp256k1(env: &VMHooksWrapper, key_handle: i32, message_handle: i32, sig_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_verify_secp256k1(key_handle, message_handle, sig_handle)
}
...
fn wasmer_import_encode_secp256k1_der_signature(env: &VMHooksWrapper, r_offset: i32, r_length: i32, s_offset: i32, s_length: i32, sig_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().encode_secp256k1_der_signature(env.convert_mem_ptr(r_offset), env.convert_mem_length(r_length), env.convert_mem_ptr(s_offset), env.convert_mem_length(s_length), env.convert_mem_ptr(sig_offset))
}

#[rustfmt::skip]
fn wasmer_import_managed_encode_secp256k1_der_signature(env: &VMHooksWrapper, r_handle: i32, s_handle: i32, sig_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_encode_secp256k1_der_signature(r_handle, s_handle, sig_handle)
}
...
fn wasmer_import_add_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, fst_point_xhandle: i32, fst_point_yhandle: i32, snd_point_xhandle: i32, snd_point_yhandle: i32) {
    env.vm_hooks.borrow_mut().add_ec(x_result_handle, y_result_handle, ec_handle, fst_point_xhandle, fst_point_yhandle, snd_point_xhandle, snd_point_yhandle)
}
...
fn wasmer_import_double_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, point_xhandle: i32, point_yhandle: i32) {
    env.vm_hooks.borrow_mut().double_ec(x_result_handle, y_result_handle, ec_handle, point_xhandle, point_yhandle)
}

#[rustfmt::skip]
fn wasmer_import_is_on_curve_ec(env: &VMHooksWrapper, ec_handle: i32, point_xhandle: i32, point_yhandle: i32) -> i32 {
    env.vm_hooks.borrow_mut().is_on_curve_ec(ec_handle, point_xhandle, point_yhandle)
}
...
fn wasmer_import_scalar_base_mult_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> i32 {
    env.vm_hooks.borrow_mut().scalar_base_mult_ec(x_result_handle, y_result_handle, ec_handle, env.convert_mem_ptr(data_offset), env.convert_mem_length(length))
}
...
fn wasmer_import_managed_scalar_base_mult_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_scalar_base_mult_ec(x_result_handle, y_result_handle, ec_handle, data_handle)
}
...
fn wasmer_import_scalar_mult_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, point_xhandle: i32, point_yhandle: i32, data_offset: i32, length: i32) -> i32 {
    env.vm_hooks.borrow_mut().scalar_mult_ec(x_result_handle, y_result_handle, ec_handle, point_xhandle, point_yhandle, env.convert_mem_ptr(data_offset), env.convert_mem_length(length))
}
...
fn wasmer_import_managed_scalar_mult_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, point_xhandle: i32, point_yhandle: i32, data_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_scalar_mult_ec(x_result_handle, y_result_handle, ec_handle, point_xhandle, point_yhandle, data_handle)
}

#[rustfmt::skip]
fn wasmer_import_marshal_ec(env: &VMHooksWrapper, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().marshal_ec(x_pair_handle, y_pair_handle, ec_handle, env.convert_mem_ptr(result_offset))
}
...
fn wasmer_import_managed_marshal_ec(env: &VMHooksWrapper, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_marshal_ec(x_pair_handle, y_pair_handle, ec_handle, result_handle)
}
...
fn wasmer_import_marshal_compressed_ec(env: &VMHooksWrapper, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().marshal_compressed_ec(x_pair_handle, y_pair_handle, ec_handle, env.convert_mem_ptr(result_offset))
}
...
fn wasmer_import_managed_marshal_compressed_ec(env: &VMHooksWrapper, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_marshal_compressed_ec(x_pair_handle, y_pair_handle, ec_handle, result_handle)
}
...
fn wasmer_import_unmarshal_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> i32 {
    env.vm_hooks.borrow_mut().unmarshal_ec(x_result_handle, y_result_handle, ec_handle, env.convert_mem_ptr(data_offset), env.convert_mem_length(length))
}
...
fn wasmer_import_managed_unmarshal_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_unmarshal_ec(x_result_handle, y_result_handle, ec_handle, data_handle)
}
...
fn wasmer_import_unmarshal_compressed_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> i32 {
    env.vm_hooks.borrow_mut().unmarshal_compressed_ec(x_result_handle, y_result_handle, ec_handle, env.convert_mem_ptr(data_offset), env.convert_mem_length(length))
}
...
fn wasmer_import_managed_unmarshal_compressed_ec(env: &VMHooksWrapper, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_unmarshal_compressed_ec(x_result_handle, y_result_handle, ec_handle, data_handle)
}
...
fn wasmer_import_generate_key_ec(env: &VMHooksWrapper, x_pub_key_handle: i32, y_pub_key_handle: i32, ec_handle: i32, result_offset: i32) -> i32 {
    env.vm_hooks.borrow_mut().generate_key_ec(x_pub_key_handle, y_pub_key_handle, ec_handle, env.convert_mem_ptr(result_offset))
}
...
fn wasmer_import_managed_generate_key_ec(env: &VMHooksWrapper, x_pub_key_handle: i32, y_pub_key_handle: i32, ec_handle: i32, result_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_generate_key_ec(x_pub_key_handle, y_pub_key_handle, ec_handle, result_handle)
}

#[rustfmt::skip]
fn wasmer_import_create_ec(env: &VMHooksWrapper, data_offset: i32, data_length: i32) -> i32 {
    env.vm_hooks.borrow_mut().create_ec(env.convert_mem_ptr(data_offset), env.convert_mem_length(data_length))
}

#[rustfmt::skip]
fn wasmer_import_managed_create_ec(env: &VMHooksWrapper, data_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_create_ec(data_handle)
}

#[rustfmt::skip]
fn wasmer_import_get_curve_length_ec(env: &VMHooksWrapper, ec_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_curve_length_ec(ec_handle)
}

#[rustfmt::skip]
fn wasmer_import_get_priv_key_byte_length_ec(env: &VMHooksWrapper, ec_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().get_priv_key_byte_length_ec(ec_handle)
}
...
fn wasmer_import_elliptic_curve_get_values(env: &VMHooksWrapper, ec_handle: i32, field_order_handle: i32, base_point_order_handle: i32, eq_constant_handle: i32, x_base_point_handle: i32, y_base_point_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().elliptic_curve_get_values(ec_handle, field_order_handle, base_point_order_handle, eq_constant_handle, x_base_point_handle, y_base_point_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_verify_secp256r1(env: &VMHooksWrapper, key_handle: i32, message_handle: i32, sig_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_verify_secp256r1(key_handle, message_handle, sig_handle)
}
...
fn wasmer_import_managed_verify_blssignature_share(env: &VMHooksWrapper, key_handle: i32, message_handle: i32, sig_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_verify_blssignature_share(key_handle, message_handle, sig_handle)
}
...
fn wasmer_import_managed_verify_blsaggregated_signature(env: &VMHooksWrapper, key_handle: i32, message_handle: i32, sig_handle: i32) -> i32 {
    env.vm_hooks.borrow_mut().managed_verify_blsaggregated_signature(key_handle, message_handle, sig_handle)
}
