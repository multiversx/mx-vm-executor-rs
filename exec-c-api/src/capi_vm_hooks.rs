...
impl elrond_exec_service::VMHooks for CapiVMHooks {
    ...
    fn get_sc_address(&self, result_offset: i32) {
        (self.c_func_pointers_ptr.get_sc_address_func_ptr)(self.vm_hooks_ptr, result_offset)
    }

    fn get_owner_address(&self, result_offset: i32) {
        (self.c_func_pointers_ptr.get_owner_address_func_ptr)(self.vm_hooks_ptr, result_offset)
    }

    fn get_shard_of_address(&self, address_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_shard_of_address_func_ptr)(self.vm_hooks_ptr, address_offset)
    }

    fn is_smart_contract(&self, address_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.is_smart_contract_func_ptr)(self.vm_hooks_ptr, address_offset)
    }

    fn signal_error(&self, message_offset: i32, message_length: i32) {
        (self.c_func_pointers_ptr.signal_error_func_ptr)(self.vm_hooks_ptr, message_offset, message_length)
    }

    fn get_external_balance(&self, address_offset: i32, result_offset: i32) {
        (self.c_func_pointers_ptr.get_external_balance_func_ptr)(self.vm_hooks_ptr, address_offset, result_offset)
    }

    fn get_block_hash(&self, nonce: i64, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_block_hash_func_ptr)(self.vm_hooks_ptr, nonce, result_offset)
    }

    fn get_esdt_balance(&self, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_balance_func_ptr)(self.vm_hooks_ptr, address_offset, token_id_offset, token_id_len, nonce, result_offset)
    }

    fn get_esdt_nft_name_length(&self, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_nft_name_length_func_ptr)(self.vm_hooks_ptr, address_offset, token_id_offset, token_id_len, nonce)
    }

    fn get_esdt_nft_attribute_length(&self, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_nft_attribute_length_func_ptr)(self.vm_hooks_ptr, address_offset, token_id_offset, token_id_len, nonce)
    }

    fn get_esdt_nft_uri_length(&self, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_nft_uri_length_func_ptr)(self.vm_hooks_ptr, address_offset, token_id_offset, token_id_len, nonce)
    }
    ...
    fn get_esdt_token_data(&self, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, value_handle: i32, properties_offset: i32, hash_offset: i32, name_offset: i32, attributes_offset: i32, creator_offset: i32, royalties_handle: i32, uris_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_token_data_func_ptr)(self.vm_hooks_ptr, address_offset, token_id_offset, token_id_len, nonce, value_handle, properties_offset, hash_offset, name_offset, attributes_offset, creator_offset, royalties_handle, uris_offset)
    }
    ...
    fn transfer_value(&self, dest_offset: i32, value_offset: i32, data_offset: i32, length: i32) -> i32 {
        (self.c_func_pointers_ptr.transfer_value_func_ptr)(self.vm_hooks_ptr, dest_offset, value_offset, data_offset, length)
    }
    ...
    fn transfer_value_execute(&self, dest_offset: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.transfer_value_execute_func_ptr)(self.vm_hooks_ptr, dest_offset, value_offset, gas_limit, function_offset, function_length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn transfer_esdt_execute(&self, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.transfer_esdt_execute_func_ptr)(self.vm_hooks_ptr, dest_offset, token_id_offset, token_id_len, value_offset, gas_limit, function_offset, function_length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn transfer_esdt_nft_execute(&self, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, nonce: i64, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.transfer_esdt_nft_execute_func_ptr)(self.vm_hooks_ptr, dest_offset, token_id_offset, token_id_len, value_offset, nonce, gas_limit, function_offset, function_length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn multi_transfer_esdt_nft_execute(&self, dest_offset: i32, num_token_transfers: i32, token_transfers_args_length_offset: i32, token_transfer_data_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.multi_transfer_esdt_nft_execute_func_ptr)(self.vm_hooks_ptr, dest_offset, num_token_transfers, token_transfers_args_length_offset, token_transfer_data_offset, gas_limit, function_offset, function_length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn create_async_call(&self, dest_offset: i32, value_offset: i32, data_offset: i32, data_length: i32, success_offset: i32, success_length: i32, error_offset: i32, error_length: i32, gas: i64, extra_gas_for_callback: i64) -> i32 {
        (self.c_func_pointers_ptr.create_async_call_func_ptr)(self.vm_hooks_ptr, dest_offset, value_offset, data_offset, data_length, success_offset, success_length, error_offset, error_length, gas, extra_gas_for_callback)
    }

    fn set_async_context_callback(&self, callback: i32, callback_length: i32, data: i32, data_length: i32, gas: i64) -> i32 {
        (self.c_func_pointers_ptr.set_async_context_callback_func_ptr)(self.vm_hooks_ptr, callback, callback_length, data, data_length, gas)
    }
    ...
    fn upgrade_contract(&self, dest_offset: i32, gas_limit: i64, value_offset: i32, code_offset: i32, code_metadata_offset: i32, length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) {
        (self.c_func_pointers_ptr.upgrade_contract_func_ptr)(self.vm_hooks_ptr, dest_offset, gas_limit, value_offset, code_offset, code_metadata_offset, length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn upgrade_from_source_contract(&self, dest_offset: i32, gas_limit: i64, value_offset: i32, source_contract_address_offset: i32, code_metadata_offset: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) {
        (self.c_func_pointers_ptr.upgrade_from_source_contract_func_ptr)(self.vm_hooks_ptr, dest_offset, gas_limit, value_offset, source_contract_address_offset, code_metadata_offset, num_arguments, arguments_length_offset, data_offset)
    }

    fn delete_contract(&self, dest_offset: i32, gas_limit: i64, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) {
        (self.c_func_pointers_ptr.delete_contract_func_ptr)(self.vm_hooks_ptr, dest_offset, gas_limit, num_arguments, arguments_length_offset, data_offset)
    }

    fn async_call(&self, dest_offset: i32, value_offset: i32, data_offset: i32, length: i32) {
        (self.c_func_pointers_ptr.async_call_func_ptr)(self.vm_hooks_ptr, dest_offset, value_offset, data_offset, length)
    }
    ...
    fn get_argument(&self, id: i32, arg_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_argument_func_ptr)(self.vm_hooks_ptr, id, arg_offset)
    }

    fn get_function(&self, function_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_function_func_ptr)(self.vm_hooks_ptr, function_offset)
    }
    ...
    fn storage_store(&self, key_offset: i32, key_length: i32, data_offset: i32, data_length: i32) -> i32 {
        (self.c_func_pointers_ptr.storage_store_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, data_offset, data_length)
    }

    fn storage_load_length(&self, key_offset: i32, key_length: i32) -> i32 {
        (self.c_func_pointers_ptr.storage_load_length_func_ptr)(self.vm_hooks_ptr, key_offset, key_length)
    }

    fn storage_load_from_address(&self, address_offset: i32, key_offset: i32, key_length: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.storage_load_from_address_func_ptr)(self.vm_hooks_ptr, address_offset, key_offset, key_length, data_offset)
    }

    fn storage_load(&self, key_offset: i32, key_length: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.storage_load_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, data_offset)
    }

    fn set_storage_lock(&self, key_offset: i32, key_length: i32, lock_timestamp: i64) -> i32 {
        (self.c_func_pointers_ptr.set_storage_lock_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, lock_timestamp)
    }

    fn get_storage_lock(&self, key_offset: i32, key_length: i32) -> i64 {
        (self.c_func_pointers_ptr.get_storage_lock_func_ptr)(self.vm_hooks_ptr, key_offset, key_length)
    }

    fn is_storage_locked(&self, key_offset: i32, key_length: i32) -> i32 {
        (self.c_func_pointers_ptr.is_storage_locked_func_ptr)(self.vm_hooks_ptr, key_offset, key_length)
    }

    fn clear_storage_lock(&self, key_offset: i32, key_length: i32) -> i32 {
        (self.c_func_pointers_ptr.clear_storage_lock_func_ptr)(self.vm_hooks_ptr, key_offset, key_length)
    }

    fn get_caller(&self, result_offset: i32) {
        (self.c_func_pointers_ptr.get_caller_func_ptr)(self.vm_hooks_ptr, result_offset)
    }
    ...
    fn get_call_value(&self, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_call_value_func_ptr)(self.vm_hooks_ptr, result_offset)
    }

    fn get_esdt_value(&self, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_value_func_ptr)(self.vm_hooks_ptr, result_offset)
    }

    fn get_esdt_value_by_index(&self, result_offset: i32, index: i32) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_value_by_index_func_ptr)(self.vm_hooks_ptr, result_offset, index)
    }

    fn get_esdt_token_name(&self, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_token_name_func_ptr)(self.vm_hooks_ptr, result_offset)
    }

    fn get_esdt_token_name_by_index(&self, result_offset: i32, index: i32) -> i32 {
        (self.c_func_pointers_ptr.get_esdt_token_name_by_index_func_ptr)(self.vm_hooks_ptr, result_offset, index)
    }
    ...
    fn get_current_esdt_nft_nonce(&self, address_offset: i32, token_id_offset: i32, token_id_len: i32) -> i64 {
        (self.c_func_pointers_ptr.get_current_esdt_nft_nonce_func_ptr)(self.vm_hooks_ptr, address_offset, token_id_offset, token_id_len)
    }
    ...
    fn get_call_value_token_name(&self, call_value_offset: i32, token_name_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_call_value_token_name_func_ptr)(self.vm_hooks_ptr, call_value_offset, token_name_offset)
    }

    fn get_call_value_token_name_by_index(&self, call_value_offset: i32, token_name_offset: i32, index: i32) -> i32 {
        (self.c_func_pointers_ptr.get_call_value_token_name_by_index_func_ptr)(self.vm_hooks_ptr, call_value_offset, token_name_offset, index)
    }

    fn write_log(&self, data_pointer: i32, data_length: i32, topic_ptr: i32, num_topics: i32) {
        (self.c_func_pointers_ptr.write_log_func_ptr)(self.vm_hooks_ptr, data_pointer, data_length, topic_ptr, num_topics)
    }

    fn write_event_log(&self, num_topics: i32, topic_lengths_offset: i32, topic_offset: i32, data_offset: i32, data_length: i32) {
        (self.c_func_pointers_ptr.write_event_log_func_ptr)(self.vm_hooks_ptr, num_topics, topic_lengths_offset, topic_offset, data_offset, data_length)
    }
    ...
    fn get_block_random_seed(&self, pointer: i32) {
        (self.c_func_pointers_ptr.get_block_random_seed_func_ptr)(self.vm_hooks_ptr, pointer)
    }

    fn get_state_root_hash(&self, pointer: i32) {
        (self.c_func_pointers_ptr.get_state_root_hash_func_ptr)(self.vm_hooks_ptr, pointer)
    }
    ...
    fn get_prev_block_random_seed(&self, pointer: i32) {
        (self.c_func_pointers_ptr.get_prev_block_random_seed_func_ptr)(self.vm_hooks_ptr, pointer)
    }

    fn finish(&self, pointer: i32, length: i32) {
        (self.c_func_pointers_ptr.finish_func_ptr)(self.vm_hooks_ptr, pointer, length)
    }
    ...
    fn execute_on_same_context(&self, gas_limit: i64, address_offset: i32, value_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.execute_on_same_context_func_ptr)(self.vm_hooks_ptr, gas_limit, address_offset, value_offset, function_offset, function_length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn execute_on_dest_context(&self, gas_limit: i64, address_offset: i32, value_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.execute_on_dest_context_func_ptr)(self.vm_hooks_ptr, gas_limit, address_offset, value_offset, function_offset, function_length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn execute_read_only(&self, gas_limit: i64, address_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.execute_read_only_func_ptr)(self.vm_hooks_ptr, gas_limit, address_offset, function_offset, function_length, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn create_contract(&self, gas_limit: i64, value_offset: i32, code_offset: i32, code_metadata_offset: i32, length: i32, result_offset: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.create_contract_func_ptr)(self.vm_hooks_ptr, gas_limit, value_offset, code_offset, code_metadata_offset, length, result_offset, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn deploy_from_source_contract(&self, gas_limit: i64, value_offset: i32, source_contract_address_offset: i32, code_metadata_offset: i32, result_address_offset: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.deploy_from_source_contract_func_ptr)(self.vm_hooks_ptr, gas_limit, value_offset, source_contract_address_offset, code_metadata_offset, result_address_offset, num_arguments, arguments_length_offset, data_offset)
    }
    ...
    fn get_return_data(&self, result_id: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.get_return_data_func_ptr)(self.vm_hooks_ptr, result_id, data_offset)
    }
    ...
    fn get_original_tx_hash(&self, data_offset: i32) {
        (self.c_func_pointers_ptr.get_original_tx_hash_func_ptr)(self.vm_hooks_ptr, data_offset)
    }

    fn get_current_tx_hash(&self, data_offset: i32) {
        (self.c_func_pointers_ptr.get_current_tx_hash_func_ptr)(self.vm_hooks_ptr, data_offset)
    }

    fn get_prev_tx_hash(&self, data_offset: i32) {
        (self.c_func_pointers_ptr.get_prev_tx_hash_func_ptr)(self.vm_hooks_ptr, data_offset)
    }
    ...
    fn managed_create_async_call(&self, dest_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, success_offset: i32, success_length: i32, error_offset: i32, error_length: i32, gas: i64, extra_gas_for_callback: i64, callback_closure_handle: i32) -> i32 {
        (self.c_func_pointers_ptr.managed_create_async_call_func_ptr)(self.vm_hooks_ptr, dest_handle, value_handle, function_handle, arguments_handle, success_offset, success_length, error_offset, error_length, gas, extra_gas_for_callback, callback_closure_handle)
    }
    ...
    fn big_int_storage_store_unsigned(&self, key_offset: i32, key_length: i32, source_handle: i32) -> i32 {
        (self.c_func_pointers_ptr.big_int_storage_store_unsigned_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, source_handle)
    }

    fn big_int_storage_load_unsigned(&self, key_offset: i32, key_length: i32, destination_handle: i32) -> i32 {
        (self.c_func_pointers_ptr.big_int_storage_load_unsigned_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, destination_handle)
    }
    ...
    fn big_int_get_external_balance(&self, address_offset: i32, result: i32) {
        (self.c_func_pointers_ptr.big_int_get_external_balance_func_ptr)(self.vm_hooks_ptr, address_offset, result)
    }
    ...
    fn big_int_get_esdt_external_balance(&self, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_handle: i32) {
        (self.c_func_pointers_ptr.big_int_get_esdt_external_balance_func_ptr)(self.vm_hooks_ptr, address_offset, token_id_offset, token_id_len, nonce, result_handle)
    }
    ...
    fn big_int_get_unsigned_bytes(&self, reference_handle: i32, byte_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.big_int_get_unsigned_bytes_func_ptr)(self.vm_hooks_ptr, reference_handle, byte_offset)
    }

    fn big_int_get_signed_bytes(&self, reference_handle: i32, byte_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.big_int_get_signed_bytes_func_ptr)(self.vm_hooks_ptr, reference_handle, byte_offset)
    }

    fn big_int_set_unsigned_bytes(&self, destination_handle: i32, byte_offset: i32, byte_length: i32) {
        (self.c_func_pointers_ptr.big_int_set_unsigned_bytes_func_ptr)(self.vm_hooks_ptr, destination_handle, byte_offset, byte_length)
    }

    fn big_int_set_signed_bytes(&self, destination_handle: i32, byte_offset: i32, byte_length: i32) {
        (self.c_func_pointers_ptr.big_int_set_signed_bytes_func_ptr)(self.vm_hooks_ptr, destination_handle, byte_offset, byte_length)
    }
    ...
    fn mbuffer_new_from_bytes(&self, data_offset: i32, data_length: i32) -> i32 {
        (self.c_func_pointers_ptr.mbuffer_new_from_bytes_func_ptr)(self.vm_hooks_ptr, data_offset, data_length)
    }
    ...
    fn mbuffer_get_bytes(&self, m_buffer_handle: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.mbuffer_get_bytes_func_ptr)(self.vm_hooks_ptr, m_buffer_handle, result_offset)
    }

    fn mbuffer_get_byte_slice(&self, source_handle: i32, starting_position: i32, slice_length: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.mbuffer_get_byte_slice_func_ptr)(self.vm_hooks_ptr, source_handle, starting_position, slice_length, result_offset)
    }
    ...
    fn mbuffer_set_bytes(&self, m_buffer_handle: i32, data_offset: i32, data_length: i32) -> i32 {
        (self.c_func_pointers_ptr.mbuffer_set_bytes_func_ptr)(self.vm_hooks_ptr, m_buffer_handle, data_offset, data_length)
    }

    fn mbuffer_set_byte_slice(&self, m_buffer_handle: i32, starting_position: i32, data_length: i32, data_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.mbuffer_set_byte_slice_func_ptr)(self.vm_hooks_ptr, m_buffer_handle, starting_position, data_length, data_offset)
    }
    ...
    fn mbuffer_append_bytes(&self, accumulator_handle: i32, data_offset: i32, data_length: i32) -> i32 {
        (self.c_func_pointers_ptr.mbuffer_append_bytes_func_ptr)(self.vm_hooks_ptr, accumulator_handle, data_offset, data_length)
    }
    ...
    fn small_int_storage_store_unsigned(&self, key_offset: i32, key_length: i32, value: i64) -> i32 {
        (self.c_func_pointers_ptr.small_int_storage_store_unsigned_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, value)
    }

    fn small_int_storage_store_signed(&self, key_offset: i32, key_length: i32, value: i64) -> i32 {
        (self.c_func_pointers_ptr.small_int_storage_store_signed_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, value)
    }

    fn small_int_storage_load_unsigned(&self, key_offset: i32, key_length: i32) -> i64 {
        (self.c_func_pointers_ptr.small_int_storage_load_unsigned_func_ptr)(self.vm_hooks_ptr, key_offset, key_length)
    }

    fn small_int_storage_load_signed(&self, key_offset: i32, key_length: i32) -> i64 {
        (self.c_func_pointers_ptr.small_int_storage_load_signed_func_ptr)(self.vm_hooks_ptr, key_offset, key_length)
    }
    ...
    fn int64storage_store(&self, key_offset: i32, key_length: i32, value: i64) -> i32 {
        (self.c_func_pointers_ptr.int64storage_store_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, value)
    }

    fn int64storage_load(&self, key_offset: i32, key_length: i32) -> i64 {
        (self.c_func_pointers_ptr.int64storage_load_func_ptr)(self.vm_hooks_ptr, key_offset, key_length)
    }

    fn sha256(&self, data_offset: i32, length: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.sha256_func_ptr)(self.vm_hooks_ptr, data_offset, length, result_offset)
    }
    ...
    fn keccak256(&self, data_offset: i32, length: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.keccak256_func_ptr)(self.vm_hooks_ptr, data_offset, length, result_offset)
    }
    ...
    fn ripemd160(&self, data_offset: i32, length: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.ripemd160_func_ptr)(self.vm_hooks_ptr, data_offset, length, result_offset)
    }
    ...
    fn verify_bls(&self, key_offset: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.verify_bls_func_ptr)(self.vm_hooks_ptr, key_offset, message_offset, message_length, sig_offset)
    }
    ...
    fn verify_ed25519(&self, key_offset: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.verify_ed25519_func_ptr)(self.vm_hooks_ptr, key_offset, message_offset, message_length, sig_offset)
    }
    ...
    fn verify_custom_secp256k1(&self, key_offset: i32, key_length: i32, message_offset: i32, message_length: i32, sig_offset: i32, hash_type: i32) -> i32 {
        (self.c_func_pointers_ptr.verify_custom_secp256k1_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, message_offset, message_length, sig_offset, hash_type)
    }
    ...
    fn verify_secp256k1(&self, key_offset: i32, key_length: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.verify_secp256k1_func_ptr)(self.vm_hooks_ptr, key_offset, key_length, message_offset, message_length, sig_offset)
    }
    ...
    fn encode_secp256k1_der_signature(&self, r_offset: i32, r_length: i32, s_offset: i32, s_length: i32, sig_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.encode_secp256k1_der_signature_func_ptr)(self.vm_hooks_ptr, r_offset, r_length, s_offset, s_length, sig_offset)
    }
    ...
    fn scalar_base_mult_ec(&self, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> i32 {
        (self.c_func_pointers_ptr.scalar_base_mult_ec_func_ptr)(self.vm_hooks_ptr, x_result_handle, y_result_handle, ec_handle, data_offset, length)
    }
    ...
    fn scalar_mult_ec(&self, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, point_xhandle: i32, point_yhandle: i32, data_offset: i32, length: i32) -> i32 {
        (self.c_func_pointers_ptr.scalar_mult_ec_func_ptr)(self.vm_hooks_ptr, x_result_handle, y_result_handle, ec_handle, point_xhandle, point_yhandle, data_offset, length)
    }
    ...
    fn marshal_ec(&self, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.marshal_ec_func_ptr)(self.vm_hooks_ptr, x_pair_handle, y_pair_handle, ec_handle, result_offset)
    }
    ...
    fn marshal_compressed_ec(&self, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.marshal_compressed_ec_func_ptr)(self.vm_hooks_ptr, x_pair_handle, y_pair_handle, ec_handle, result_offset)
    }
    ...
    fn unmarshal_ec(&self, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> i32 {
        (self.c_func_pointers_ptr.unmarshal_ec_func_ptr)(self.vm_hooks_ptr, x_result_handle, y_result_handle, ec_handle, data_offset, length)
    }
    ...
    fn unmarshal_compressed_ec(&self, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> i32 {
        (self.c_func_pointers_ptr.unmarshal_compressed_ec_func_ptr)(self.vm_hooks_ptr, x_result_handle, y_result_handle, ec_handle, data_offset, length)
    }
    ...
    fn generate_key_ec(&self, x_pub_key_handle: i32, y_pub_key_handle: i32, ec_handle: i32, result_offset: i32) -> i32 {
        (self.c_func_pointers_ptr.generate_key_ec_func_ptr)(self.vm_hooks_ptr, x_pub_key_handle, y_pub_key_handle, ec_handle, result_offset)
    }
    ...
    fn create_ec(&self, data_offset: i32, data_length: i32) -> i32 {
        (self.c_func_pointers_ptr.create_ec_func_ptr)(self.vm_hooks_ptr, data_offset, data_length)
    }
